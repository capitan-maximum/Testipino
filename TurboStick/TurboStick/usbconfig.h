 ...
 */
#define USB_CFG_VENDOR_NAME     'l', 'u', 'r', 'j', 'u', 's', '@', 'k', 'o', 'a', 'l', 'i', 't', 'i', 'o', '.', 'f', 'i'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'T', 'u', 'r', 'b', 'o', 's', 't', 'i', 'c', 'k', ' ', '5', '0', '0', '0'
...
#define USB_INTR_CFG_SET        (1 << PCINT18) //PD5/PCINT21
